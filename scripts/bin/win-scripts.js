...
const { sync } = require('@winner-fed/utils/compiled/cross-spawn')
const chalk = require('@winner-fed/utils/compiled/chalk').default
...
console.log(chalk.cyan(`win-scripts: ${name}\n`))
...
if (spawn.status !== 0) {
  console.log(chalk.red(`win-scripts: ${name} execute fail`))
  process.exit(1)
}
